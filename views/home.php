...
<head>
    ...
    <title>DungeonXplorer - Page d'accueil</title>
    <link rel="stylesheet" href="style/styles.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@700&family=Roboto+Serif&display=swap" rel="stylesheet">
</head>
<body>
    <header class="header">
    ...
    <main class="main-content">
        <section class="intro">
            <h2>Bienvenue dans l'univers de DungeonXplorer</h2>
            <p> l'univers de dark fantasy où se mêlent aventure, stratégie et immersion
    ...
    <footer>
        <p>&copy; 2023 DungeonXplorer. Tous droits réservés.</p>
    </footer>
</body>
</html>